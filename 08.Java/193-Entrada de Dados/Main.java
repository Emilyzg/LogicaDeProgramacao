...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Scanner sc = new Scanner(System.in); //limpeza de buffer
        ...
        sexo = sc.next().charAt(0);  //ler no char coluna 0
        ...
        sc.close(); //desalocar os recursos do scaner
